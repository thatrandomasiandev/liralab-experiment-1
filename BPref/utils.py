...
# Meta-World is only required for Meta-World tasks; keep DMControl runnable without it.
try:
    import metaworld
    import metaworld.envs.mujoco.env_dict as _env_dict
    from rlkit.envs.wrappers import NormalizedBoxEnv
except ImportError:  # pragma: no cover - optional dependency for DMControl-only runs
    metaworld = None
    _env_dict = None
    NormalizedBoxEnv = None
...
def make_metaworld_env(cfg):
    if metaworld is None or _env_dict is None or NormalizedBoxEnv is None:
        raise ImportError(
            "Meta-World is not installed. Install metaworld to run Meta-World tasks."
        )
